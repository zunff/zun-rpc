...
public class RegistryServiceCache {
    ...
    public static void removeCacheByServiceNodeKey(String serviceNodeKey) {
        CACHE.keySet().stream().filter(serviceKey -> serviceNodeKey.startsWith(serviceKey)).forEach(serviceKey -> {
            ...
            //传进来的值为：/rpc/com.zunf.common.service.UserService:1.0/localhost:8099
            //serviceMetaInfo.getServiceNodeKey()的值为：com.zunf.common.service.UserService:1.0/localhost:8099
            //所以用endWith
